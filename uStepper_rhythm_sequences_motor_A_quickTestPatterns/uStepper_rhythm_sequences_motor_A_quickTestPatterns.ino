...
#define QUICK_TEST_PATTERN_TIME 30000    // Time to spend on each pattern in quick test mode (30 seconds)
...
void setup() {
  ...
  Serial.begin(9600);
  Serial.println("Beat Sequencer v2.3 with Zero Position Initialisation and Quick Test Mode");
